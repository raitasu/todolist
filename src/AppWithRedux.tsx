...
function AppWithRedux() {
    ...
    const changeFilter = useCallback((value: FilterButtonType, todolistId: string) => {
    ...
    const changeTaskStatus = useCallback((todolistId: string, taskId: string, checked: boolean) => {
